$(document).ready(function(){
	...
	$('#sales_order_table').bootstrapTable({
		...
		queryParams : function(params) {
			var soid = $("#input_id_search_sales_order_audit").val();
			var gname = $("#input_gname_search_sales_order_audit").val();
			var supplierId = $("#input_supplier_name_search_sales_order_audit").val();
			var storageId = $("#input_storage_name_search_sales_order_audit").val();
			var createrName = $("#input_creater_name_search_sales_order_audit").val();
			var createdTime = $("#input_created_time_search_sales_order_audit").val().toString("yyyy-MM-dd");
			var outOfStoreTime = $("#input_out_of_store_time_search_sales_order_audit").val().toString("yyyy-MM-dd");
  ...
  //操作栏的格式化
    ...
    function setOnClickOutputData(){
    	$("#btn_output_data_sales_order_audit").on("click",function(){
    		var soid = $("#input_id_search_sales_order_audit").val();
    		var gname = $("#input_gname_search_sales_order_audit").val();
    		var supplierId = $("#input_supplier_name_search_sales_order_audit").val();
    		var storageId = $("#input_storage_name_search_sales_order_audit").val();
    		...
    		var createdTime = $("#input_created_time_search_sales_order_audit").val().toString("yyyy-MM-dd");
    		var outOfStoreTime = $("#input_out_of_store_time_search_sales_order_audit").val().toString("yyyy-MM-dd");
    		var url = $("#btn_output_data_sales_order_audit").attr("url");
    		$.get(url,
    				{
						pageSize : pageSize,
						currentPage : currentPage,
    ...
    function setOutputUrl(){
		...
		$("#btn_output_data_sales_order_audit").attr("href", url);
    }
	...
	function getOrderStatuses(){
		var select = $("#input_audit_status_search_sales_order_audit");
	...
	function getStorages(){
		var select = $("#input_storage_name_search_sales_order_audit");
		var url = select.attr("url");
		$.post(url,
				{},
				    function(result,status){
	...
	function getSuppliers(){
		var select = $("#input_supplier_name_search_sales_order_audit");
		var url = select.attr("url");
		$.post(url,
				{},
				function(result,status){
