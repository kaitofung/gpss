...
<body class="main-container ">
				...
				<div class="col-md-12" style="margin-top: 7px;">
					<span style="margin-right: 5px;"> <label>经办人：</label> <input
						...
						<div class="input-group date form_date " data-date=""
							...
							<input id="input_created_time_search_sales_order_audit"
								name="input_created_time_search_sales_order_audit"
					...
					<span style="margin-right: 5px;"> <label>出库时间：</label>
						<div class="input-group date form_date " data-date=""
							data-date-format="yyyy-mm-dd" data-link-field="dtp_input2"
							data-link-format="yyyy-mm-dd">
							<input id="input_out_of_store_time_search_sales_order_audit"
								name="input_out_of_store_time_search_sales_order_audit"
								class="form-control" size="16" type="text" value="" readonly /><span
								class="input-group-addon"><span
								class="glyphicon glyphicon-remove"></span></span> <span
								class="input-group-addon"><span
	...
	<#include "/sales_order_audit_sales_order_edit_diolog.ftl"> 
</body>
...
<script src="${base}/js/sales-order_audit.js"></script>
