...
<body>
					...
					<form class="form-horizontal form-label-left" id="edit_purchase_order_form"
						...
						<div class="item form-group">
							...
							<div class="col-md-6 col-sm-6 col-xs-12">
								<select name="input_goods_name_purchase_order_edit"
									id="input_goods_name_purchase_order_edit"
						...
						<div class="item form-group">
							...
							<div class="col-md-6 col-sm-6 col-xs-12">
								<select name="input_goods_specification_purchase_order_edit"
									id="input_goods_specification_purchase_order_edit"
						...
						<div class="item form-group">
							...
							<div class="col-md-6 col-sm-6 col-xs-12">
								<select name="input_supplier_name_purchase_order_edit"
									id="input_supplier_name_purchase_order_edit"
						...
						<div class="item form-group">
							...
							<div class="col-md-6 col-sm-6 col-xs-12">
								<select name="input_storage_name_purchase_order_edit"
									id="input_storage_name_purchase_order_edit"
	...
	<script src="../js/purchase_manage_purchase_order_edit_diolog.js"></script>
	<!-- 时间选择器的JS -->
	<script>
