...
<body>
	...
	<div class="modal fade" 
		...
		id="editSalesOrderModal" tabindex="-1" role="dialog"
		...
		<div class="modal-dialog" style="min-width: 700px;">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title" id="myModalLabel">编辑销售订单</h4>
				</div>
					...
					<form class="form-horizontal form-label-left" id="edit_sales_order_form"
						...
						<div class="item form-group">
							...
							<div class="col-md-6 col-sm-6 col-xs-12">
								<select name="input_goods_name_sales_order_edit"
									id="input_goods_name_sales_order_edit"
						...
						<div class="item form-group">
							...
							<div class="col-md-6 col-sm-6 col-xs-12">
								<select name="input_client_name_sales_order_edit"
									id="input_client_name_sales_order_edit" type="text" class="form-control"
									url ="${context}/sales/clients"
									>
						...
						<div class="item form-group">
							...
							<div class="col-md-6 col-sm-6 col-xs-12">
								<select name="input_goods_specification_sales_order_edit"
									id="input_goods_specification_sales_order_edit"
						...
						<div class="item form-group">
							...
							<div class="col-md-6 col-sm-6 col-xs-12">
								<select name="input_supplier_name_sales_order_edit"
									id="input_supplier_name_sales_order_edit"
						...
						<div class="item form-group">
							...
							<div class="col-md-6 col-sm-6 col-xs-12">
								<select name="input_storage_name_sales_order_edit"
									id="input_storage_name_sales_order_edit"
						...
						<div class="item form-group">
							...
							<div class="col-md-6 col-sm-6 col-xs-12">
								<input id="input_goods_count_sales_order_edit"
									class="form-control col-md-7 col-xs-12"
									name="input_goods_count_sales_order_edit" placeholder="请输入商品数量"
						...
						<div class="item form-group">
							...
							<div class="col-md-6 col-sm-6 col-xs-12">
								<input  id="input_goods_price_sales_order_edit" onkeyup="this.value=this.value.replace(/[^\d.]/g,'')" 
									class="form-control col-md-7 col-xs-12"
									name="input_goods_price_sales_order_edit" placeholder="请输入商品单价"
						...
						<div class="item form-group">
							...
							<div class="col-md-6 col-sm-6 col-xs-12">
								<input id="input_goods_sum_sales_order_edit"
									class="form-control col-md-7 col-xs-12"
									name="input_goods_sum_sales_order_edit" placeholder="请输入总价"
						...
						<div class="item form-group">
							...
							<div class="col-md-6 col-sm-6 col-xs-12">
								<textarea id="input_appendix_sales_order_edit"
									class="form-control col-md-7 col-xs-12"
									name="input_appendix_sales_order_edit" placeholder="请输入订单备注"
									type="text"  />
							</div>
						</div>
	...
	<script src="../js/sales_manage_sales_order_edit_diolog.js"></script>
	<!-- 时间选择器的JS -->
	<script>
